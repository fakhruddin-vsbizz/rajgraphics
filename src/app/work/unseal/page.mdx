...
export const caseStudy = {
  client: 'Unseal',
  title: 'All Storming the Brain - UX, Engineer and Business',
  description:
    'We have a unique roundtable solution mechanism where we call all disciplines, put forth the problems and allow the creators to give birth to your magnificent product.',
  summary: [
