...
export const caseStudy = {
  client: 'Phobia',
  title: 'Work like one, independently and robustfully',
  description:
    'The circle of development starts after client verifies the solution flow by using latest SOTA technical, management and business development processes to ensure you get more than what you asked for.',
  summary: [
