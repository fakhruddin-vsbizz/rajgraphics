...
export const caseStudy = {
  client: 'FamilyFund',
  title: 'Putting all ears on',
  description:
    'We let our clients not just tell them our problems, but also vent out their experiences which helps us create ecstatic experience design for them.',
  summary: [
